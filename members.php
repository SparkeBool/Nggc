        ...
        <div class="main-panel">
            ...
            <nav class="navbar navbar-expand-lg " color-on-scroll="500">
                <div class="container-fluid">
                    <a class="navbar-brand" href="#pablo"> MEMBERS </a>
                          ...
                          <?php
                              ...
                              if(isset($_POST['update'])) {
                                    ...
                                    if($stmt = $conn->prepare('UPDATE member SET FNAME=?, LNAME=?, ADDRESS=?, STATE=?, CITY=?, PHONE=?, ACCT_NUM =?, ACCT_NAME=?, BANK_NAME=?, ABOUT=? WHERE username=?')){
                                       ...
                                       $stmt->bind_param('sssssssssss',$_POST['fname'],$_POST['lname'], $_POST['address'], $_POST['state'], $_POST['city'], $_POST['phone'],$_POST['acctNo'], $_POST['acctName'], $_POST['bankName'], $_POST['about'], $_GET['show']);
                                      $stmt->execute();
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                   <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>" method="post"  enctype="multipart/form-data">
                                        ...
                                        <button type="submit" class="btn btn-primary btn-fill pull-right" name="update">Update Profile</button>
                        ...
                        <div class="col-md-5">
                              ...
                              <div class="card  ">
                                ...
                                <!--here showing results in the table -->
                                            ...
                                            <td><a href="members.php?show=<?php echo $username ?>"><button class="btn btn-sm btn-danger" style="cursor:pointer;">View Details</button></a></td><!--btn btn-danger is a bootstrap button to show danger-->
                                        </tr>

                                      <?php }
                                            }else{echo "<tr colspan ='4'><td> No users Available </td></tr>";} ?>
